        ...
        public struct Indicator: Equatable {
            public struct StateConfig: Equatable {
                ...
                public init(
                    ...
                    backgroundColor: UIColor = .defaultScrollBarBackground,
                    insets: UIEdgeInsets = UIEdgeInsets(top: 8, left: 0, bottom: 8, right: 0),
                    image: UIImage? = UIImage(systemName: "arrow.up.and.down.circle")?.withRenderingMode(.alwaysOriginal).withTintColor(.systemBackground),
